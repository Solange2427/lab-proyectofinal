...
<header class="container"> <h3><a href="/inicio" ><span class="label label-danger">Inicio </span></a></h3> </header>
					...
					<DIV>
						<h5>
							Ruc del cliente: <input type="text" class="form-control"
								name="rucCliente" value="<%=factura.getRucClient()%>" readonly
								required>
						</h5>
					</div>
				</div>
				<div class="col-md-6">
					<div>
						...
						CODIGO: <input type="text" class="form-control" name="idPedido"
							value="<%=factura.getId()%>" readonly required>
					</div>
					<div>
						</h5>
						Fecha de emision: <input type="text" class="form-control"
							name="idPedido" value="<%=factura.getDate()%>" readonly required>
					</div>
				</div>
			</div>
		</div>
			...
			<tbody>
				<tr>
					...
					<td class=" text-right "><input type="text"
						...
						value="<%=factura.getTotal()%>" readonly required></td>
 ...
 %>
	...
	<div class="text-center">
		<a href="/bills" class="btn btn-block btn-primary">VOLVER</a> <br>
	</div>
...
<div class="container">
	...
	<div id="myPrintArea">Zona que se imprimirá</div>
