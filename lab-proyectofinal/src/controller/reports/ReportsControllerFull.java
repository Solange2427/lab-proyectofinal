...
@SuppressWarnings("serial")
	public class ReportsControllerFull extends HttpServlet {
		public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
			...
			if(Usuario == null){
				...
				List<Users> arrayUsers = (List<Users>)query.execute("select from Users");

				req.setAttribute("arrayUsers", arrayUsers);
				try {
					req.getRequestDispatcher("/WEB-INF/Views/Reports/full.jsp").forward(req, resp);
					query.closeAll();
