...
public class BillsControllerUpdate  extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(Usuario == null){
			...
			try {
				...
				Bills factura= pm.getObjectById(Bills.class,codigoLong);
				
				req.setAttribute("factura",factura);
				req.getRequestDispatcher("/WEB-INF/Views/Bill/update.jsp").forward(req, resp);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		try{
			...
			Bills factura = pm.getObjectById(Bills.class,codigoLong);
			factura.setNameClient(nombreCliente);
			factura.setRucClient(rucCliente);
