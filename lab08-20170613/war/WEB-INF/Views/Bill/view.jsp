...
<div class="panel panel-default">
  <div class="panel-body" c>
  	...
  	<DIV><h5>Ruc del cliente: <input type="text" class="form-control" name="rucCliente" value="<%=factura.getRucClient() %>" readonly required></h5></div></div>
  		...
  		<div></h5>Fecha de emision: <input type="text" class="form-control" name="idPedido" value="<%=factura.getDate()%>" readonly required></div></div>
  </div>
</div>
</div>
...
<table class="table table-bordered">
	...
	<tbody>
		<tr >
		<td ><input type="text" class="form-control" name="nombreProducto" value="<%=factura.getNameProduct()%>" readonly required></td>
		<td><a href="#"> <input type="text" class="form-control" name="cantidad" value="<%=factura.getQuantityProduct() %>" readonly required></a></td>
		<td class=" text-right "><input type="text" class="form-control" name="precio" value="<%=factura.getPriceProduct() %>" readonly required></td>
		<td class=" text-right "><input type="text" class="form-control" name="subtotal" value="<%=factura.getTotal() %>" readonly required></td>
...
<div><input type="text" class="form-control" name="idPedido" value="<%=factura.getTotal()%>" readonly required></div>

</strong></div>
</div>
</div>
<div class="text-center">
			<a href="/bills" class="btn btn-block btn-primary">VOLVER</a>
			<br>
			</div>
