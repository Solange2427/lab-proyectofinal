...
public class BillsControllerView extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(Usuario == null){
			...
			Bills factura=pm.getObjectById(Bills.class,Long.parseLong(id));
			
			req.setAttribute("factura",factura); //cambiar mas adelante
			
			RequestDispatcher dispatcher=getServletContext().getRequestDispatcher ("/WEB-INF/Views/Bill/view.jsp");
			 try {
