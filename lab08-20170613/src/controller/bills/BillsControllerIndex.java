...
@SuppressWarnings("serial")
	public class BillsControllerIndex extends HttpServlet {
		public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
			...
			if(Usuario == null){
				...
				Query query = pm.newQuery(Bills.class);
				
				List<Bills> array = (List<Bills>)query.execute("select from Project");

				req.setAttribute("array", array);
				try {
					req.getRequestDispatcher("/WEB-INF/Views/Bill/index.jsp").forward(req, resp);
					query.closeAll();
