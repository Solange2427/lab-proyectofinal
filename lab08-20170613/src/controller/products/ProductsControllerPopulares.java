...
@SuppressWarnings("serial")
	public class ProductsControllerPopulares extends HttpServlet {
		public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
			...
			if(Usuario == null){
				...
				Order or = pm.getObjectById(Order.class , codigoLong);
				
				Long idProduct = or.getProduct();
				Product p = pm.getObjectById(Product.class , idProduct);
				
				req.setAttribute("product", p);
				req.setAttribute("order", or);
			
				
				RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/Views/Products/popular.jsp");
				rd.forward(req, resp);
