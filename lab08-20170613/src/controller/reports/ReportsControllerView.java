...
public class ReportsControllerView extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		if(Usuario == null){
			...
			Report reporte=pm.getObjectById(Report.class,Long.parseLong(id));
			
			Long codigoLong=reporte.getIdCliente();
			Users usuario=pm.getObjectById(Users.class,codigoLong);
			
			req.setAttribute("usuario",usuario);
			req.setAttribute("reporte",reporte); //cambiar mas adelante
			
			RequestDispatcher dispatcher=getServletContext().getRequestDispatcher ("/WEB-INF/Views/Reports/view.jsp");
			 try {
